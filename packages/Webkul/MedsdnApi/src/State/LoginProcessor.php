...
use Webkul\MedsdnApi\Validators\LoginValidator;
...
class LoginProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = [])
    {
            ...
            if ($operation->getName() === 'create') {
                ...
                if (! $customer || ! Hash::check($data->password, $customer->password)) {
                    return (object) [
                        ...
                        'token'    => '',
                        'success'  => false,
                        'message'  => __('medsdnapi::app.graphql.login.invalid-credentials'),
                    ];
                }
                ...
                if ($customer->is_suspended) {
                    return (object) [
                        ...
                        'token'    => '',
                        'success'  => false,
                        'message'  => __('medsdnapi::app.graphql.login.account-suspended'),
                    ];
                }
                ...
                return (object) [
                    ...
                    'token'    => $token,
                    'success'  => true,
                    'message'  => __('medsdnapi::app.graphql.login.successful'),
                ];
            }
        }
        ...
        return (object) [
            ...
            'token'    => '',
            'success'  => false,
            'message'  => __('medsdnapi::app.graphql.login.invalid-request'),
        ];
    }
}
