...
use Webkul\MedsdnApi\Dto\ContactUsInput;
...
class ContactUsProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): object
    {
        if (! ($data instanceof ContactUsInput)) {
            return (object) [
                'success' => false,
                'message' => __('medsdnapi::app.graphql.contact-us.invalid-input'),
            ];
        }
        ...
        try {
            ...
            return (object) [
                'success' => true,
                'message' => __('medsdnapi::app.graphql.contact-us.success'),
            ];
        } catch (\Exception $e) {
            report($e);
            ...
            return (object) [
                'success' => false,
                'message' => __('medsdnapi::app.graphql.contact-us.failed'),
            ];
        }
    }
}
