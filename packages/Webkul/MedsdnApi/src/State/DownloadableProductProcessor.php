 ...
 *
 * Implements API Platform processor interface to handle MedsdnApi mutations
...
class DownloadableProductProcessor implements ProcessorInterface
{
    ...
    /**
     * Process MedsdnApi mutation to generate a download link.
     *
    ...
    public function process($data, ?Operation $operation = null, array $uriVariables = [], array $context = [])
    {
        ...
        $downloadLink = \Webkul\MedsdnApi\Models\DownloadableProductDownloadLink::create([
            'token'                          => $token,
            'url'                            => url($downloadUrl),
