...
use Webkul\MedsdnApi\Http\Requests\Admin\ProductFormRequest;
...
#[ApiResource(
    ...
    graphQlOperations: [
        new Mutation(
            name: 'create',
            processor: \Webkul\MedsdnApi\State\ProductProcessor::class,
        ...
        new Query(
            ...
            resolver: SingleProductMedsdnApiResolver::class
        ),
    ]
)]
#[ApiResource(
...
class Product extends BaseProduct
{
     ...
     * Override to return MedsdnApi AttributeFamily model
     */
    ...
    /**
     * Get product minimum price for MedsdnApi API.
     * Exposed to MedsdnApi schema via ApiProperty attribute.
     */
    #[ApiProperty(writable: false, readable: true, required: false)]
    ...
    /**
     * Get product maximum price for MedsdnApi API.
     * Exposed to MedsdnApi schema via ApiProperty attribute.
     */
    #[ApiProperty(writable: false, readable: true, required: false)]
    ...
    /**
     * Get product regular minimum price for MedsdnApi API.
     * Exposed to MedsdnApi schema via ApiProperty attribute.
     */
    #[ApiProperty(writable: false, readable: true, required: false)]
    ...
    /**
     * Get product regular maximum price for MedsdnApi API.
     * Exposed to MedsdnApi schema via ApiProperty attribute.
     */
    #[ApiProperty(writable: false, readable: true, required: false)]
