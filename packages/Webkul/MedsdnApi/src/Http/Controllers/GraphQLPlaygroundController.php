...
async function initCryptoKey(passphrase) {
    ...
    CRYPTO_KEY = await crypto.subtle.deriveKey(
        { name: 'PBKDF2', salt: enc.encode('medsdn-graphiql-v1'), iterations: 100000, hash: 'SHA-256' },
        keyMaterial,
...
/* ═══════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════ */
var AUTH_TOKEN_KEY = 'medsdn-graphiql-auth-token';
var CART_TOKEN_KEY = 'medsdn-graphiql-cart-token';
