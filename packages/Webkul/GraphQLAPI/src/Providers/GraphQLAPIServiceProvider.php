...
use Webkul\GraphQLAPI\Facades\MedSDNGraphql as MedSDNGraphqlFacade;
...
class GraphQLAPIServiceProvider extends ServiceProvider
{
    ...
    protected function registerFacades(): void
    {
        ...
        $loader->alias('medsdn_graphql', MedSDNGraphqlFacade::class);

        $this->app->singleton('medsdn_graphql', function () {
    ...
    public function boot(): void
    {
        ...
        $this->loadTranslationsFrom(__DIR__.'/../Resources/lang', 'medsdn_graphql');

        $this->loadViewsFrom(__DIR__.'/../Resources/views', 'medsdn_graphql');
