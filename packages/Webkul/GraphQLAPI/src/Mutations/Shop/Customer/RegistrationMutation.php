...
class RegistrationMutation extends Controller
{
    ...
    public function signUp(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (core()->getConfigData('customer.settings.email.verification')) {
            return [
                'success' => false,
                'message' => trans('medsdn_graphql::app.shop.customers.signup.success-verify'),
            ];
        }
    ...
    public function socialSignIn(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (
            ...
            throw new CustomException(trans('medsdn_graphql::app.shop.customers.social-login.disabled'));
        }
        ...
        if ($args['signup_type'] == 'truecaller') {
            ...
            if (
                ...
                throw new CustomException(
                    trans('medsdn_graphql::app.shop.customers.login.validation.unique', ['phone' => $args['phone']])
                );
            }
        } else {
    ...
    public function create($data)
    {
        ...
        if (! $customer) {
            return [
                'success' => false,
                'message' => trans('medsdn_graphql::app.shop.customers.signup.error-registration'),
            ];
        }
    ...
    public function login($data, $password = null)
    {
        if (! $jwtToken = JWTAuth::attempt([
            ...
            throw new CustomException(trans('medsdn_graphql::app.shop.customers.login.invalid-creds'));
        }
        ...
        if (! empty($password)) {
            ...
            if (! $loginCustomer->status) {
                ...
                return [
                    'success' => false,
                    'message' => trans('medsdn_graphql::app.shop.customers.login.not-activated'),
                ];
            }
            ...
            if (! $loginCustomer->is_verified) {
                ...
                return [
                    'success' => false,
                    'message' => trans('medsdn_graphql::app.shop.customers.login.verify-first'),
                ];
            }
        }
        ...
        return [
            ...
            ? trans('medsdn_graphql::app.shop.customers.success-login')
            : trans('medsdn_graphql::app.shop.customers.signup.success'),
