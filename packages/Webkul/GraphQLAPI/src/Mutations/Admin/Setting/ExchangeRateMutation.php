...
class ExchangeRateMutation extends Controller
{
    ...
    public function store(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $currency) {
            throw new CustomException(trans('medsdn_graphql::app.admin.settings.exchange-rates.invalid-target-currency'));
        }
        ...
        try {
            ...
            return [
                'success'       => true,
                'message'       => trans('medsdn_graphql::app.admin.settings.exchange-rates.create-success'),
    ...
    public function update(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $exchangeRate) {
            throw new CustomException(trans('medsdn_graphql::app.admin.settings.exchange-rates.not-found'));
        }
        ...
        try {
            ...
            return [
                'success'       => true,
                'message'       => trans('medsdn_graphql::app.admin.settings.exchange-rates.update-success'),
                'exchange_rate' => $exchangeRate,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('medsdn_graphql::app.admin.settings.exchange-rates.delete-success'),
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
        }
