...
class AttributeMutation extends Controller
{
    ...
    public function store(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            if (
                ...
                $localeFields = medsdn_graphql()->manageLocaleFields($args['translations'], $this->localeFields);
            ...
            if (
                ...
                foreach ($attribute->options as $option) {
                    if (
                        ...
                        medsdn_graphql()->uploadImage($option, $swatch_value[$option->admin_name], 'attribute_option/', 'swatch_value');
                    }
                }
            }
            ...
            return [
                'success'   => true,
                'message'   => trans('medsdn_graphql::app.admin.catalog.attributes.create-success'),
                'attribute' => $attribute,
            ];
        } catch (\Exception $e) {
    ...
    public function update(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $attribute) {
            throw new CustomException(trans('medsdn_graphql::app.admin.catalog.attributes.not-found'));
        }
        ...
        try {
            ...
            return [
                'success'   => true,
                'message'   => trans('medsdn_graphql::app.admin.catalog.attributes.update-success'),
                'attribute' => $attribute,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $attribute->is_user_defined) {
            throw new CustomException(trans('medsdn_graphql::app.admin.catalog.attributes.user-define-error'));
        }
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('medsdn_graphql::app.admin.catalog.attributes.delete-success'),
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
        }
    ...
    public function manageAttributeOptions($data)
    {
        ...
        foreach ($data['options'] as $index => $option) {
            ...
            $localeFields = medsdn_graphql()->manageLocaleFields($option['translations'], ['label']);
