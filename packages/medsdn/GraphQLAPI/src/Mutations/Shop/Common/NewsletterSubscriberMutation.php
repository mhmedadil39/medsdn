...
class NewsletterSubscriberMutation extends Controller
{
    ...
    public function subscribe(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if ($subscription) {
            throw new CustomException(trans('medsdn_graphql::app.shop.subscription.already-subscribed'));
        }
        ...
        try {
            ...
            return [
                'success'      => true,
                'message'      => trans('medsdn_graphql::app.shop.subscription.subscribe-success'),
            ];
        } catch (\Exception $e) {
