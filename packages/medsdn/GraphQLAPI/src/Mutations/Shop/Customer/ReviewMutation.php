...
class ReviewMutation extends Controller
{
    ...
    public function store(mixed $rootValue, array $args, GraphQLContext $context)
    {
        if (
            ...
            return [
                'success' => false,
                'message' => trans('medsdn_graphql::app.shop.customers.reviews.not-auth'),
            ];
        }
        ...
        try {
            ...
            if (! $product) {
                throw new CustomException(trans('medsdn_graphql::app.shop.customers.reviews.product-not-found'));
            }
            ...
            return [
                'success' => true,
                'message' => trans('medsdn_graphql::app.shop.customers.reviews.create-success'),
                'review'  => $review,
            ];
        } catch (\Exception $e) {
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $review) {
            return [
                'success' => false,
                'message' => trans('medsdn_graphql::app.shop.customers.reviews.not-found'),
        ...
        return [
            'success' => $isDeleted,
            'message' => $isDeleted
                ? trans('medsdn_graphql::app.shop.customers.reviews.delete-success')
                : trans('medsdn_graphql::app.shop.customers.reviews.not-found'),
            'reviews' => $customer->reviews,
        ];
    }
        ...
        try {
            ...
            return [
                ...
                'message' => $customerReviews->count()
                    ? trans('medsdn_graphql::app.shop.customers.reviews.mass-delete-success')
                    : trans('medsdn_graphql::app.shop.customers.reviews.not-found'),
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
