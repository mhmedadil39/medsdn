...
class SessionMutation extends Controller
{
    ...
    public function login(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            $customer = medsdn_graphql()->authorize(token: $jwtToken);
            ...
            return [
                'success'      => true,
                'message'      => trans('medsdn_graphql::app.shop.customers.success-login'),
    ...
    public function logout()
    {
        ...
        return [
            'success' => true,
            'message' => trans('medsdn_graphql::app.shop.customers.success-logout'),
        ];
    }
}
