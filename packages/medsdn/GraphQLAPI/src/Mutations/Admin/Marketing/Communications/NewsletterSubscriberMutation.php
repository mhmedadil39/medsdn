...
class NewsletterSubscriberMutation extends Controller
{
    ...
    public function unSubscribe(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $subscriber) {
            throw new CustomException(trans('medsdn_graphql::app.admin.marketing.communications.subscriptions.not-found'));
        }
        ...
        try {
            ...
            return [
                'success'    => true,
                'message'    => trans('medsdn_graphql::app.admin.marketing.communications.subscriptions.unsubscribe-success'),
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('medsdn_graphql::app.admin.marketing.communications.subscriptions.delete-success'),
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
        }
