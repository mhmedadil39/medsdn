...
class CatalogRuleMutation extends Controller
{
    ...
    public function store(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success'      => true,
                'message'      => trans('medsdn_graphql::app.admin.marketing.promotions.catalog-rules.create-success'),
    ...
    public function update(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $catalogRule) {
            throw new CustomException(trans('medsdn_graphql::app.admin.marketing.promotions.catalog-rules.not-found'));
        }
        ...
        try {
            ...
            return [
                'success'      => true,
                'message'      => trans('medsdn_graphql::app.admin.marketing.promotions.catalog-rules.update-success'),
                'catalog_rule' => $catalogRule,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('medsdn_graphql::app.admin.marketing.promotions.catalog-rules.delete-success'),
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
        }
