...
class CustomerAddressMutation extends Controller
{
    ...
    public function store(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $customer) {
            throw new CustomException(trans('medsdn_graphql::app.admin.customers.customers.not-found'));
        }
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('medsdn_graphql::app.admin.customers.addresses.create-success'),
    ...
    public function update(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $customerAddress) {
            throw new CustomException(trans('medsdn_graphql::app.admin.customers.addresses.not-found'));
        }
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('medsdn_graphql::app.admin.customers.addresses.update-success'),
                'address' => $customerAddress,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
    ...
    public function setAsDefaultAddress(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if ($address->default_address) {
            throw new CustomException(trans('medsdn_graphql::app.admin.customers.addresses.already-default'));
        }
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('medsdn_graphql::app.admin.customers.addresses.default-update-success'),
                'address' => $address,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('medsdn_graphql::app.admin.customers.addresses.delete-success'),
            ];
