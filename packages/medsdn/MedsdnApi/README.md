...
2. Extract it to: `packages/medsdn/MedsdnApi/`
...
**Documentation:**
- REST API: See `packages/medsdn/BankTransfer/API_DOCUMENTATION.md`
- GraphQL API: See `packages/medsdn/MedsdnApi/BANK_TRANSFER_GRAPHQL.md`
...
- Bank Transfer REST API: `packages/medsdn/BankTransfer/API_DOCUMENTATION.md`
- Bank Transfer GraphQL API: `packages/medsdn/MedsdnApi/BANK_TRANSFER_GRAPHQL.md`
