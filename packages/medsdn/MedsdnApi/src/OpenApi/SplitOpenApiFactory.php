...
namespace Webkul\MedsdnApi\OpenApi;
...
class SplitOpenApiFactory implements OpenApiFactoryInterface
{
    ...
    public function __invoke(array $context = []): OpenApi
    {
        ...
        if ($endpointType === 'shop') {
            ...
            $description = 'MedSDN Shop API - Customer-facing operations for products, cart, orders, and checkout.';
            ...
            $description = 'MedSDN Admin API - Administrative operations for store management and configuration.';
        }
