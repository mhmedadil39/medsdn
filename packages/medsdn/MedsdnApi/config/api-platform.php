...
return [
    ...
    'routes' => [
        ...
        // MedsdnApiDocumentationMiddleware: Handles custom /api index and documentation pages
        ...
        'middleware' => [
            'Webkul\MedsdnApi\Http\Middleware\HandleInvalidInputException',
            'Webkul\MedsdnApi\Http\Middleware\SecurityHeaders',
            'Webkul\MedsdnApi\Http\Middleware\LogApiRequests',
            'Webkul\MedsdnApi\Http\Middleware\SetLocaleChannel',
            'Webkul\MedsdnApi\Http\Middleware\VerifyStorefrontKey',
            'Webkul\MedsdnApi\Http\Middleware\MedsdnApiDocumentationMiddleware',
            'Webkul\MedsdnApi\Http\Middleware\ForceApiJson',
            'Spatie\ResponseCache\Middlewares\CacheResponse',
        ],
    ],

    'resources' => [
        base_path('packages/medsdn/MedsdnApi/src/Models/'),
    ],
    ...
    'graphql' => [
        ...
        'middleware' => [
            'Webkul\MedsdnApi\Http\Middleware\SetLocaleChannel',
            'Webkul\MedsdnApi\Http\Middleware\VerifyGraphQLStorefrontKey',
        ],
    ],
