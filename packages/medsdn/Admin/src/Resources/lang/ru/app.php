...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Пароль',
            'powered-by-description' => 'Работает на MedSDN, проект с открытым исходным кодом от MedSDN.',
            'submit-btn' => 'Войти',
            'title' => 'Войти',
        ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Работает на MedSDN, проект с открытым исходным кодом от MedSDN.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => 'Разработано на платформе <a href="https://medsdn.com/" target="_blank">MedSDN</a>, Проект сообщества <a href="https://medsdn.com/" target="_blank">MedSDN</a>',
    ],
