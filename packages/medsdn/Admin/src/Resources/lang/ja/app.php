...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'パスワード',
            'powered-by-description' => 'MedSDN によるオープンソースプロジェクト MedSDN によって提供されています。',
            'submit-btn' => 'サインイン',
            'title' => 'サインイン',
        ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'MedSDN によるオープンソースプロジェクト MedSDN によって提供されています。',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '搭載 <a href="https://medsdn.com/" target="_blank">MedSDN</a>, MedSDNによるコミュニティプロジェクト<a href="https://medsdn.com/" target="_blank">MedSDN</a>',
    ],
