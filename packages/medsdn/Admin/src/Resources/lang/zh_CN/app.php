...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => '密码',
            'powered-by-description' => '由 MedSDN 提供支持，一个由 MedSDN 社区支持的项目。',
            'submit-btn' => '登录',
            'title' => '登录',
        ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '由 MedSDN 提供支持，一个由 MedSDN 社区支持的项目。',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '由 <a href="https://medsdn.com/" target="_blank">MedSDN</a> 提供支持，一个由 <a href="https://medsdn.com/" target="_blank">MedSDN</a> 社区支持的项目',
    ],
