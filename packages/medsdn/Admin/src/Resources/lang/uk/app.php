...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Пароль',
            'powered-by-description' => 'Працює на платформі MedSDN, спільний проект MedSDN.',
            'submit-btn' => 'Увійти',
            'title' => 'Увійти',
        ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Працює на платформі MedSDN, спільний проект MedSDN.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => 'Працює на платформі <a href="https://medsdn.com/" target="_blank">MedSDN</a>, Спільний проект <a href="https://medsdn.com/" target="_blank">MedSDN</a>',
    ],
